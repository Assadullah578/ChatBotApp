...
function ChatButton(props) {
    return (
        <View className=" border border-blue-200 rounded-lg items-center justify-center h-[150px] w-[140px] space-y-8">
            ...
            <Text className="text-black px-6 ">{props.btntxt}</Text>
        </View>
    );
}
